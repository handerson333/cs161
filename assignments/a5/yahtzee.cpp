...
void show_categories(long int **scorecard, long int player);
...
void show_categories(long int **scorecard, long int player){
	int i = 1;
	vector<string> cats; cats.push_back("category 7 is: 3 of a kind"); cats.push_back("category 8 is: 4 of a kind"); cats.push_back("category 9 is: full house"); 
	cats.push_back("category 10 is: small straight"); cats.push_back("category 11 is: large straight"); cats.push_back("category 12 is: chance"); cats.push_back("category 13 is: YAHTZEE!!!");
	cout << "\n";
	while (i <7){
		if(scorecard[player][i-1] == -1){
