...
int check_sides(char** board, int rows, int cols, int num, int i, int j);
int check_corners(char** board, int rows, int cols, int num1, int i, int j);
...
void pick_coords(char **board, char **user_array, int rows, int cols, int mines);
...
void main2() ;
void check_win(char **board, char **user_array, int rows, int cols, int mines);
...
*********************************************************************/ 
int check_sides(char** board, int rows, int cols, int num, int y, int x) {
	if (y < rows - 1) {
		if (board[y + 1][x] == '*')//top
			num++;
	}
...
** Return: amount of mines
*********************************************************************/ 
int check_corners(char** board, int rows, int cols, int num, int i, int j) {
